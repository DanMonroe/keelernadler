                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="title"><g:message code="accountType.title.label" default="Title" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: accountTypeInstance, field: 'title', 'errors')}">
                                    <g:textField name="title" maxlength="15" value="${accountTypeInstance?.title}" />
                                </td>
                            </tr>
