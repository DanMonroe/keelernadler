...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                <g:hiddenField name="id" value="${billingScheduleInstance?.id}" />
                <g:hiddenField name="version" value="${billingScheduleInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="selectedMonths"><g:message code="billingSchedule.selectedMonths.label" default="Selected Months" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: billingScheduleInstance, field: 'selectedMonths', 'errors')}">
                                  <kn:monthsCheckBoxList name="selectedMonths" value="${billingScheduleInstance?.selectedMonths}" height="270px"/>
